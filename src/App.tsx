...
import MailLinkedTemplate from './container/EmailSubmitted';
...
import EmailSubmitted from './container/EmailSubmitted';
    ...
    return (
        <>
            ...
            <Switch>
                ...
                <Route path={url.emailSubmitted} component={EmailSubmitted} />
